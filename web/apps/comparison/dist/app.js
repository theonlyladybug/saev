...
var $author$project$Comparison$main = $elm$browser$Browser$application(
	{
		init: $author$project$Comparison$init,
		onUrlChange: $author$project$Comparison$onUrlChange,
		onUrlRequest: $author$project$Comparison$onUrlRequest,
		subscriptions: function (model) {
			return $elm$core$Platform$Sub$none;
		},
		update: $author$project$Comparison$update,
