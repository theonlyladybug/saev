...
def train_sae_on_language_model(
    ...
    while n_training_tokens < total_training_tokens:
        ...
        if (feature_sampling_method == "anthropic") and (
            ...
            if sparse_autoencoder.cfg.dead_feature_estimation_method == "no_fire":
                dead_neuron_indices = (act_freq_scores == 0).nonzero(as_tuple=False)[
                    :, 0
                ]
            ...
            if len(dead_neuron_indices) > 0:
                if (
                    ...
                    > sparse_autoencoder.cfg.resample_batches
                    * sparse_autoencoder.cfg.store_batch_size
                ):
                    print(
        ...
        if (feature_sampling_method == "l2") and (
            (n_training_steps + 1) % dead_feature_window == 0
        ):
