...
from sae_training.config import LanguageModelSAERunnerConfig, ViTSAERunnerConfig
...
class ViTSparseAutoencoderSessionloader:
    ...
    def load_session(
        self,
    ) -> Tuple[HookedVisionTransformer, SparseAutoencoder, ViTActivationsStore]:
        """
    ...
    def load_session_from_pretrained(
        cls, path: str
    ) -> Tuple[HookedTransformer, SparseAutoencoder, ViTActivationsStore]:
        """
    ...
    def get_activations_loader(
        self, cfg: ViTSAERunnerConfig, model: HookedVisionTransformer
    ):
        """
